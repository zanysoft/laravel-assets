...
class ImageLib
{
    ...
    *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
    ...
    /**
     * Create rounded corners on your image
     * @param int $radius radius = the amount of curvature
     * @param string $bgColor the corner background color
     */
     ...
     * @param int $shadowAngle the angle of the shadow
     * @param int $blur the blur distance
    ...
    /**
     * Add a caption box
     * @param string $side the side to add the caption box (t, r, b, or l).
     * @param int $thickness how thick you want the caption box to be.
     * @param int $padding
     * @param string $bgColor The color of the caption box.
     * @param int $transaprencyAmount The amount of transparency to be applied.
     */
    ...
    /**
     * Simplify adding text to a caption box by automatically
     * @param $text The usually text paams (less a couple)
    ...
    /**
     * Get image EXIF data
     * @return mixed  An associate array of EXIF data
     */
     ...
     * @param $dat | index (120 for caption, 118 for contact. See the IPTC IIM specification
     * @param $val | value/data/text. Make sure this is within the length constraints of the IPTC IIM specification
     * @return string
     */
